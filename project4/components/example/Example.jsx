...
class Example extends React.Component {
  constructor(props) {
    ...
    this.handleChangeBound2 = event => this.handleChance(event);
    ...
    return (
      ...
      <Header/>
        ...
        <div className="motto-update">
          ...
          <p> Hello, My name is {this.state.motto}.</p>
          <div className = "cs142-example-output">
          <label htmlFor="inId">Input Field:</label> 
          <input type="text" value={this.state.motto} onChange={this.handleChangeBound2}/>
          </div> 
        </div>
...
`<p>My name is "{this.state.name}".</p>`
        ...
        <p className="cs142-example-output">
          My name is &ldquo; {this.state.name}.
        </p>
